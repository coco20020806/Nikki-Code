    ...
    <Layout>
      <div className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          录入入口：<a className="underline" href="/admin.html">/admin.html</a>。
          这个页面主要用于删除已存在的兑换码（需要管理员密码）。
        </p>
      </div>

      <div className="grid grid-cols-1 gap-8">
        <div>
          <Card className="glass-card min-h-full border-white/60">
            <CardHeader>
              <CardTitle className="text-xl">有效与历史兑换码</CardTitle>
            </CardHeader>
            <CardContent>
